...
class SEBlock(tf.keras.layers.Layer):
    ...
    def __init__(self, channels, r_channels, kernel_regularizer=None, **kwargs):
        ...
        self.fc_1 = tf.keras.layers.Dense(
            r_channels, kernel_regularizer=kernel_regularizer, name="se_fc1"
        )
        self.bn_1 = tf.keras.layers.BatchNormalization(name="se_bn1")
        self.fc_2 = tf.keras.layers.Dense(
            channels, kernel_regularizer=kernel_regularizer, name="se_fc2"
        )
...
class ResidualBlock(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if se_factor > 0:
            self.se = SEBlock(
                filters, filters / se_factor, kernel_regularizer=kernel_regularizer
            )
...
class BottleneckBlock(tf.keras.layers.Layer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.conv_2 = conv3x3(
            filters, 1, kernel_regularizer=kernel_regularizer, name="conv_1"
        )
