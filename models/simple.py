...
class SimpleModel(tf.keras.Model):
    def __init__(self, number_of_classes):
        ...
        self.conv_1 = tf.keras.layers.Conv2D(
            32, (3, 3), padding="same", kernel_initializer="he_normal", name="conv1"
        )
